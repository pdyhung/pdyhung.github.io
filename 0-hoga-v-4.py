...
def hoga_input(user_text):
	...
	b_co = user_text[1]
	t = user_text[2]
	h_tam_dan_1 = user_text[3]
	b_tam_dan_1 = user_text[4]
	h_thanh = user_text[5]
	b_hoga = user_text[6]
	h_day = user_text[7]
	h_tam_dan_2 = user_text[8]
	i_md = user_text[9]
...
draw_hoga_pygame = TextButton("Vẽ hố ga cad", (250,525))
...
while running:
	...
	for event in pygame.event.get():
		...
		if event.type == pygame.KEYDOWN:
			...
			# elif active[1] == True:
			# 	if event.key == pygame.K_BACKSPACE:
			# 		user_text[1] = user_text[1][0:-1]
			# 	else:
			# 		user_text[1] += event.unicode
			...
			# elif active[3] == True:
			# 	if event.key == pygame.K_BACKSPACE:
			# 		user_text_4 = user_text_4[0:-1]
			# 	else:
			# 		user_text_4 += event.unicode

			# elif active[4] == True:
			# 	if event.key == pygame.K_BACKSPACE:
			# 		user_text_5 = user_text_5[0:-1]
			# 	else:
			# 		user_text_5 += event.unicode

			# elif active[5] == True:
			# 	if event.key == pygame.K_BACKSPACE:
			# 		user_text_6 = user_text_6[0:-1]
			# 	else:
			# 		user_text_6 += event.unicode

			# elif active[6] == True:
			# 	if event.key == pygame.K_BACKSPACE:
			# 		user_text_7 = user_text_7[0:-1]
			# 	else:
			# 		user_text_7 += event.unicode

			# elif active[7] == True:
			# 	if event.key == pygame.K_BACKSPACE:
			# 		user_text_8 = user_text_8[0:-1]
			# 	else:
			# 		user_text_8 += event.unicode

			# elif active[8] == True:
			# 	if event.key == pygame.K_BACKSPACE:
			# 		user_text_9 = user_text_9[0:-1]
			# 	else:
			# 		user_text_9 += event.unicode

			# elif active[9] == True:
			# 	if event.key == pygame.K_BACKSPACE:
			# 		user_text_10 = user_text_10[0:-1]
			# 	else:
			# 		user_text_10 += event.unicode
	...
	# nhap_so_1 = TextButton(user_text_1, (250,50))
	# nhap_so_1.draw()

	# nhap_so_2 = TextButton(user_text_2, (250,75))
	# nhap_so_2.draw()

	# nhap_so_3 = TextButton(user_text_3, (250,100))
	# nhap_so_3.draw()

	# nhap_so_4 = TextButton(user_text_4, (250,125))
	# nhap_so_4.draw()

	# nhap_so_5 = TextButton(user_text_5, (250,150))
	# nhap_so_5.draw()

	# nhap_so_6 = TextButton(user_text_6, (250,175))
	# nhap_so_6.draw()

	# nhap_so_7 = TextButton(user_text_7, (250,200))
	# nhap_so_7.draw()

	# nhap_so_8 = TextButton(user_text_8, (250,225))
	# nhap_so_8.draw()

	# nhap_so_9 = TextButton(user_text_9, (250,250))
	# nhap_so_9.draw()

	# nhap_so_10 = TextButton(user_text_10, (250,275))
	# nhap_so_10.draw()
