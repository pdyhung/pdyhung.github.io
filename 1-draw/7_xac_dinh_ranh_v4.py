...
def chan_taluy(side):
	...
	for i in ac_polyline_base:
		for j in range(len(lr1)-1):
			...
			angle_1 = ac_l1.Angle - math.pi/2 + side
			ac_l1.Delete()
...
def show_menu():
	...
	print("option 2: Draw chan taluy trai import csv! ")
	print("option 3: Draw chan taluy phai import csv! ")
	print("option 4: Draw polyline from chan taluy ")
	print("option 5: --> EXIT <-- ")
	print("......")
...
def main():
	while True:
		...
		if choice == "1":	
			...
			ac_points = chan_taluy(math.pi)
		elif choice == "3":
			ac_points = chan_taluy(0)			
		elif choice == "4":
