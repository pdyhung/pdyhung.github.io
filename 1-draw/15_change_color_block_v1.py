...
def set_layer_and_color_in_blocks():
    ...
    for block in block_table:
        ...
        for entity in block:
            try:
                entity.Layer = "0"
                entity.Color = 0
                print(f"Set layer of entity {entity.EntityName} in block {block.Name} to layer '0' and color to ByBlock")
            except Exception as e:
                print(f"Could not modify entity {entity.EntityName} in block {block.Name}: {e}")
    acad_Doc.Regen(1)
...
def show_menu():
	...
	print("option 1: set color and layer to block")
